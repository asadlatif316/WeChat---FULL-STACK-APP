...
const noChatHistoryPlaceHolder = ({ user }) => {
  return (
    <div className='bg-gray-100 rounded-lg flex my-auto flex-col justify-center items-center h-full text-center p-6 border border-gray-400/40 space-y-2'>
      ...
      <div>
        <h3 className='font-semibold text-lg text-muted-foreground mb-2'>
          Select a conversation with {user.name}
        </h3>
